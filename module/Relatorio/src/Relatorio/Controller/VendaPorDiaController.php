...
class VendaPordiaController extends AbstractDoctrineCrudController
{
    /**
     * @var EntityManager
     */
    ...
    {
        $this->formClass = 'Relatorio\Form\VendaPorDiaForm';
//        $this->modelClass = 'Cadastro\Model\Pule';
//        $this->namespaceTableGateway = 'Cadastro\Model\Aposta';
        $this->route = 'vendapordia';
        $this->title = 'Relatório Venda por Dia';
        $this->label['yes']	= 'Sim';
        $this->label['no']	= 'Não';
