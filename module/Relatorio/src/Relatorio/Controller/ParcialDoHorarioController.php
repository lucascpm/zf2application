...
class ParcialDoHorarioController extends AbstractDoctrineCrudController
{
    /**
     * @var EntityManager
     */
    ...
    {
        $this->formClass = 'Relatorio\Form\ParcialDoHorarioForm';
//        $this->modelClass = 'Cadastro\Model\Pule';
//        $this->namespaceTableGateway = 'Cadastro\Model\Aposta';
        $this->route = 'parcialdohorario';
        $this->title = 'Relatório Parcial';
        $this->label['yes']	= 'Sim';
        $this->label['no']	= 'Não';
