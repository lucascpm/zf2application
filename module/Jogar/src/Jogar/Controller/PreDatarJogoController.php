...
class PreDatarJogoController extends AbstractDoctrineCrudController
{
    /**
     * @var EntityManager
     */
    ...
    {
        $this->formClass = 'Jogar\Form\PreDatarJogoForm';
//        $this->modelClass = 'Cadastro\Model\Pule';
//        $this->namespaceTableGateway = 'Cadastro\Model\Aposta';
        $this->route = 'predatarjogo';
        $this->title = 'Pré-Datar Jogo';
        $this->label['yes']	= 'Sim';
        $this->label['no']	= 'Não';
