...
class PulePremiadaController extends AbstractDoctrineCrudController
{
    /**
     * @var EntityManager
     */
    ...
    {
        $this->formClass = 'Relatorio\Form\PulePremiadaForm';
//        $this->modelClass = 'Cadastro\Model\Pule';
//        $this->namespaceTableGateway = 'Cadastro\Model\Aposta';
        $this->route = 'pulepremiada';
        $this->title = 'Relatório Pule Premiada';
        $this->label['yes']	= 'Sim';
        $this->label['no']	= 'Não';
