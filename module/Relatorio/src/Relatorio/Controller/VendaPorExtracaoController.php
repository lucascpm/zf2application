...
class VendaPorExtracaoController extends AbstractDoctrineCrudController
{
    /**
     * @var EntityManager
     */
    ...
    {
        $this->formClass = 'Relatorio\Form\VendaPorExtracaoForm';
//        $this->modelClass = 'Cadastro\Model\Pule';
//        $this->namespaceTableGateway = 'Cadastro\Model\Aposta';
        $this->route = 'vendaporextracao';
        $this->title = 'Relatório Venda por Extração';
        $this->label['yes']	= 'Sim';
        $this->label['no']	= 'Não';
