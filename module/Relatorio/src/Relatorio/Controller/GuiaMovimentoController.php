...
class GuiaMovimentoController extends AbstractDoctrineCrudController
{
    /**
     * @var EntityManager
     */
    ...
    {
        $this->formClass = 'Relatorio\Form\GuiaMovimentoForm';
//        $this->modelClass = 'Cadastro\Model\Pule';
//        $this->namespaceTableGateway = 'Cadastro\Model\Aposta';
        $this->route = 'guiamovimento';
        $this->title = 'Relatório Guia Movimento';
        $this->label['yes']	= 'Sim';
        $this->label['no']	= 'Não';
